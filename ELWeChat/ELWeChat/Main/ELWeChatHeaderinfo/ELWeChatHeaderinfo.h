...
@property(nonatomic, assign) unsigned long m_uiGameType;   //游戏类型
@property(nonatomic, strong) NSString *m_nsEmoticonMD5;    //MD5
@property(nonatomic, assign) unsigned long m_uiGameContent;//游戏内容
